...
#
#tickplace = np.arange(0, 210000, 20000)
#labelplace = [int(x / div) for x in tickplace] 
#lb = 30000
#ub = 190000
#xlabs_tick = np.arange(0,20,2)
#xlabs = np.arange(5,65,5)
#xlabs_tick = [x / 3 - 1 for x in xlabs]
#
#plt.figure(figsize=(10, 8))
#
#plt.plot(P1_1_U, '-', color = 'black', lw = 3, label = 'MV Urgent')
#plt.plot(Proposed_U_Post, '-', color = 'red', lw = 3, label = 'Proposed Policy (Post)')
#plt.plot(Proposed_U_Pre, '--', color = 'red', lw = 3, label = 'Proposed Policy (Pre)')
#
#plt.plot(Proposed_10_U_Post, '-', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Post)')
#plt.plot(Proposed_10_U_Pre, '--', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Pre)')
#
#plt.plot(Proposed_20_U_Post, '-', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Post)')
#plt.plot(Proposed_20_U_Pre, '--', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Pre)')
#
#plt.xlabel('Number of MV (K)', fontsize = 16)
#plt.ylabel('Cumulated deaths (K)', fontsize = 16)
#plt.xticks(xlabs_tick, xlabs, fontsize = 16)
#plt.yticks(tickplace, labelplace, fontsize = 16)
...
#
#
## Plot death - moderate patients
#
#tickplace = np.arange(0, 180000, 4000)
#labelplace = [int(x / div) for x in tickplace] 
#lb = 4000
#ub = 28000
#xlabs_tick = np.arange(0,20,2)
...
#plt.figure(figsize=(10, 8))
#
#plt.plot(P1_1_M, '-', color = 'black', lw = 3, label = 'MV Urgent')
#plt.plot(Proposed_M_Post, '-', color = 'red', lw = 3, label = 'Proposed Policy (Post)')
#plt.plot(Proposed_M_Pre, '--', color = 'red', lw = 3, label = 'Proposed Policy (Pre)')
#
#plt.plot(Proposed_10_M_Post, '-', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Post)')
#plt.plot(Proposed_10_M_Pre, '--', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Pre)')
#
#plt.plot(Proposed_20_M_Post, '-', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Post)')
#plt.plot(Proposed_20_M_Pre, '--', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Pre)')
#
#
#plt.xlabel('Number of MV (K)', fontsize = 16)
#plt.ylabel('Cumulated deaths (K)', fontsize = 16)
...
#
#
## Plot death - deteriorated patients
#
#tickplace = np.arange(0, 200000, 5000)
#labelplace = [int(x / div) for x in tickplace] 
#lb = -2000
#ub = 60000
#xlabs_tick = np.arange(0,20,2)
...
#plt.figure(figsize=(10, 8))
#
#plt.plot(P1_1_D, '-', color = 'black', lw = 3, label = 'MV Urgent')
#plt.plot(Proposed_D_Post, '-', color = 'red', lw = 3, label = 'Proposed Policy (Post)')
#plt.plot(Proposed_D_Pre, '--', color = 'red', lw = 3, label = 'Proposed Policy (Pre)')
#
#plt.plot(Proposed_10_D_Post, '-', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Post)')
#plt.plot(Proposed_10_D_Pre, '--', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Pre)')
#
#plt.plot(Proposed_20_D_Post, '-', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Post)')
#plt.plot(Proposed_20_D_Pre, '--', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Pre)')
#
#plt.xlabel('Number of MV (K)', fontsize = 16)
#plt.ylabel('Cumulated deaths (K)', fontsize = 16)
#plt.xticks(xlabs_tick, xlabs, fontsize = 16)
...
#
#
## Plot death - stabilized patients
#
#tickplace = np.arange(0, 180000, 2000)
#labelplace = [int(x / div) for x in tickplace] 
#lb = -500
#ub = 16000
#xlabs_tick = np.arange(0,20,2)
...
#plt.figure(figsize=(10, 8))
#
#plt.plot(P1_1_S, '-', color = 'black', lw = 3, label = 'MV Urgent')
#plt.plot(Proposed_S_Post, '-', color = 'red', lw = 3, label = 'Proposed Policy (Post)')
#plt.plot(Proposed_S_Pre, '--', color = 'red', lw = 3, label = 'Proposed Policy (Pre)')
#
#plt.plot(Proposed_10_S_Post, '-', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Post)')
#plt.plot(Proposed_10_S_Pre, '--', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Pre)')
#
#plt.plot(Proposed_20_S_Post, '-', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Post)')
#plt.plot(Proposed_20_S_Pre, '--', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Pre)')
#
#plt.xlabel('Number of MV (K)', fontsize = 16)
#plt.ylabel('Cumulated deaths (K)', fontsize = 16)
#plt.xticks(xlabs_tick, xlabs, fontsize = 16)
...
#
#
### Plot full MV utilization (%)
##
##tickplace_MV = np.arange(0, 0.3, 0.05) 
##labelplace_MV = [int(round(x * 100, 1)) for x in tickplace_MV] 
##
##xlabs_tick = np.arange(0,20,2)
##xlabs = np.arange(5,65,5)
##xlabs_tick = [x / 3 - 1 for x in xlabs]
...
##plt.figure(figsize=(10, 8))
##
##plt.plot(P1_1_MV, '-', color = 'black', lw = 3, label = 'MV Urgent')
##plt.plot(Proposed_MV_Post, '-', color = 'red', lw = 3, label = 'Proposed Policy (Post)')
##plt.plot(Proposed_MV_Pre, '--', color = 'red', lw = 3, label = 'Proposed Policy (Pre)')
##
##plt.plot(Proposed_10_MV_Post, '-', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Post)')
##plt.plot(Proposed_10_MV_Pre, '--', color = 'orange', lw = 3, label = 'Proposed policy + 10% (Pre)')
##
##plt.plot(Proposed_20_MV_Post, '-', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Post)')
##plt.plot(Proposed_20_MV_Pre, '--', color = nupurple, lw = 3, label = 'Proposed policy + 20% (Pre)')
##
##plt.xlabel('Number of MV (K)', fontsize = 16)
##plt.ylabel('Full MV utilization (%)', fontsize = 16)
##plt.xticks(xlabs_tick, xlabs, fontsize = 16)
##plt.yticks(tickplace_MV, labelplace_MV, fontsize = 16)
###plt.legend(loc='upper right', fontsize = 16)
##plt.show()
#
#
