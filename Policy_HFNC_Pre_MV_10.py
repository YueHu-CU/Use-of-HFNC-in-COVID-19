...
Obj_Proposed_10_Pre = int(Death[-1])
Obj_Proposed_10_U_Pre = int(Death_U[-1]) 
Obj_Proposed_10_Non_U_Pre = int(Death_Decom[-1])

MV_Full_Proposed_10_Pre = round((MV_Left.count(0) / len(MV_Left)), 3)
