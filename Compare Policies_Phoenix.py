...
# MV capacity to enumerate for Phoenix
MV_capacity = [200, 300, 400, 500, 600, 700, 800]
...
plt.annotate('Estimated capacity', xy = (city, lb), xytext = (city - 1.2, ub - 400), fontsize = font, 
...
plt.annotate('Estimated capacity', xy = (city, lb), xytext = (city - 1.2, ub - 20), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
