...
ytick = np.arange(0, 410000, 20000)
...
plt.annotate('Estimated capacity', xy = (9.32, lb), xytext = (9.32 - 4, 220000), fontsize = font, 
...
plt.annotate('Estimated capacity', xy = (9.32, lb), xytext = (9.32 - 4, 210000), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
...
plt.annotate('Estimated capacity', xy = (9.32, 0), xytext = (9.32 - 4, 110), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
