...
# MV capacity to enumerate for New Orleans
MV_capacity = [25, 50, 75, 100, 125, 150, 175]
...
plt.annotate('Estimated capacity', xy = (city, lb), xytext = (city - 1.3, ub - 100), fontsize = font, 
...
plt.annotate('Estimated capacity', xy = (city, lb), xytext = (city - 1.3, ub - 40), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
