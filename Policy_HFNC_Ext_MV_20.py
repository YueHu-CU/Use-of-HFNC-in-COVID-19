...
Obj_Proposed_20_Post = int(Death[-1])
Obj_Proposed_20_U_Post = int(Death_U[-1]) 
Obj_Proposed_20_Non_U_Post = int(Death_Decom[-1])

MV_Full_Proposed_20_Post = round((MV_Left.count(0) / len(MV_Left)), 3)
