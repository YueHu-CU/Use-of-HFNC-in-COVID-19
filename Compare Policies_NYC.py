...
# MV capacity to enumerate for NYC
MV_capacity = [800, 1200, 1600, 2000, 2400]
...
plt.annotate('Estimated capacity', xy = (city, lb), xytext = (city - 0.8, ub - 1000), fontsize = font, 
...
ytick_MV = np.arange(10, 200, 10) 
ylabel_MV = np.arange(10, 200, 10) 
...
plt.annotate('Estimated capacity', xy = (city, lb), xytext = (city - 0.8, ub - 5), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
