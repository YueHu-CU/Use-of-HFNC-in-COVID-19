...
MV_capacity = [x * 3 for x in np.arange(1, 21, 1)] 
...
ytick = np.arange(0, 420000, 20000)
ylabel = [int(x / div) for x in ytick] 

xlabel = np.arange(5, 65, 5)
xtick = [x / 3 - 1 for x in xlabel]
...
plt.annotate('Estimated capacity', xy = (9.32, lb), xytext = (9.32 - 4, 340000), fontsize = font, 
...
plt.scatter([9.32], [current_death], color = 'blue', marker = 'x', s = 250,
...
ytick = np.arange(0, 380000, 40000)
ylabel = [int(x / div) for x in ytick] 
...
plt.annotate('Estimated capacity', xy = (9.32, lb), xytext = (9.32 - 4, 320000), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
...
ytick = np.arange(0, 260000, 40000)
ylabel = [int(x / div) for x in ytick] 
...
plt.annotate('Estimated capacity', xy = (9.32, 0), xytext = (9.32 - 4, 210000), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
...
ytick_MV = np.arange(0, 221, 20) 
ylabel_MV = np.arange(0, 221, 20) 
...
plt.annotate('Estimated capacity', xy = (9.32, 0), xytext = (9.32 - 4, 180), fontsize = font, 
            arrowprops = dict(arrowstyle = '-|>, head_length = 0.6, head_width = 0.3',
                           color = 'black', lw = 1),
            va = 'center', multialignment = 'left')
