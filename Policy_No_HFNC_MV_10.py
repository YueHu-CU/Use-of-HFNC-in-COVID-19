...
Obj_Policy_1_10 = int(Death[-1])
Obj_Policy_1_U_10 = int(Death_U[-1]) 
Obj_Policy_1_Non_U_10 = int(Death_Decom[-1])

MV_Full_Policy_1_10 = round((MV_Left.count(0) / len(MV_Left)), 3)
